...
This is a simple web application built using Flask and SQLite to manage a record collection. It allows users to log in, view, add, edit, and delete records. The application also includes features like dark mode, search filtering, sorting, and password management.
...
* Includes a Change Password feature for secure password updates.

### Frontend (templates/)
* __HTML Templates:__ Define the structure of each page.
* __CSS__ (styles.css): Styles the application with support for dark mode.
* __JavaScript__ (script.js): Adds interactivity (search filtering, theme toggling).
